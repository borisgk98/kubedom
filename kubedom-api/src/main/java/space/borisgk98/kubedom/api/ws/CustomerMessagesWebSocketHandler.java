...
@Slf4j
public class CustomerMessagesWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        sessionManager.add(session, SessionType.CUSTOMER);
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
        ...
        sessionManager.remove(session, SessionType.CUSTOMER);
    }
}
